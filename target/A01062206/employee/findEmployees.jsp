	...
	<body>
		<div class="panel panel-info">
			...
			<div style="padding-top: 15px" class="panel-body">	
				...
				<c:if test="${message.code == 000}">
					<h5>Found: <c:out value="${message.message}"/></h5>
					<h6>Result Code: <c:out value="${message.code}"/> Description: Success</h6>
				</c:if>
				<c:if test="${message.code == 901 && param.button == 'findEmployee'}">
